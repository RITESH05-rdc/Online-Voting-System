...
namespace VotingSystem {
	...
	/// Summary for Vres
	/// </summary>
	public ref class Vres : public System::Windows::Forms::Form
	{
	public:
		Vres(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Vres::typeid));
			...
			this->ListBoxResults->Size = System::Drawing::Size(240, 274);
			this->ListBoxResults->TabIndex = 0;
			this->ListBoxResults->SelectedIndexChanged += gcnew System::EventHandler(this, &Vres::ListBoxResults_SelectedIndexChanged);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(129, 555);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(241, 43);
			this->button1->TabIndex = 1;
			this->button1->Text = L"RESULTS";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Vres::button1_Click);
			// 
			// Vres
			// 
			...
			this->Text = L"Vres";
			this->Load += gcnew System::EventHandler(this, &Vres::Vres_Load);
...
#pragma endregion
	private: System::Void Vres_Load(System::Object^ sender, System::EventArgs^ e) {
	}
