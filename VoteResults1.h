...
namespace VotingSystem {
	...
	/// <summary>
	/// Summary for VoteResults
	/// </summary>
	public ref class VoteResults : public System::Windows::Forms::Form
	{
	public:
		VoteResults(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(VoteResults::typeid));
			...
			this->ListBoxResults->SelectedIndexChanged += gcnew System::EventHandler(this, &VoteResults::ListBoxResults_SelectedIndexChanged);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(117, 487);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(241, 43);
			this->button1->TabIndex = 1;
			this->button1->Text = L"RESULTS";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &VoteResults::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &VoteResults::button2_Click);
			// 
			// VoteResults
			// 
			...
			this->Name = L"VoteResults";
			this->Text = L"VoteResults";
			this->Load += gcnew System::EventHandler(this, &VoteResults::VoteResults_Load);
...
#pragma endregion
	private: System::Void VoteResults_Load(System::Object^ sender, System::EventArgs^ e) {
	}
